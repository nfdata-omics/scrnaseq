...
- Fix [533](https://github.com/nf-core/scrnaseq/issues/533), FASTQC module results in naming collisions if files have same basename ([534](https://github.com/nf-core/scrnaseq/pull/524))
