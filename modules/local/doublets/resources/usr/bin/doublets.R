...
option_list <- list(make_option(c("-o", "--output_dir"), action = "store", type = "character", default = getwd(), help = "Directory where the output files will be saved. [default: current working directory]"), make_option(c("-v", "--version"), action = "store_true", default = FALSE, help = "Print the list of loaded package versions and exit.")
)
